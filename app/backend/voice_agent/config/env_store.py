...
class EnvStore:
    ...
    def read_public(self) -> dict[str, str]:
        ...
        return {
            ...
            "PHONE_PROVIDER": values.get("PHONE_PROVIDER", "none"),
            "PHONE_CONNECTION_MODE": values.get("PHONE_CONNECTION_MODE", "automatic"),
            "PHONE_PUBLIC_BASE_URL": values.get("PHONE_PUBLIC_BASE_URL", ""),
            "PHONE_REALTIME_PROVIDER": values.get("PHONE_REALTIME_PROVIDER", ""),
            "PHONE_TRANSFER_TARGET": values.get("PHONE_TRANSFER_TARGET", ""),
            "PHONE_LAST_PROVISIONED_URL": values.get("PHONE_LAST_PROVISIONED_URL", ""),
            "PHONE_LAST_PROVISIONED_AT": values.get("PHONE_LAST_PROVISIONED_AT", ""),
            "CLOUDFLARED_BIN": values.get("CLOUDFLARED_BIN", ""),
            "TWILIO_ACCOUNT_SID": mask_secret(values.get("TWILIO_ACCOUNT_SID", "")),
            "TWILIO_AUTH_TOKEN": mask_secret(values.get("TWILIO_AUTH_TOKEN", "")),
            "TWILIO_PHONE_NUMBER": values.get("TWILIO_PHONE_NUMBER", ""),
            "TWILIO_PHONE_NUMBER_SID": mask_secret(values.get("TWILIO_PHONE_NUMBER_SID", "")),
            "TELNYX_API_KEY": mask_secret(values.get("TELNYX_API_KEY", "")),
            "TELNYX_CALL_CONTROL_APP_ID": values.get("TELNYX_CALL_CONTROL_APP_ID", ""),
            "TELNYX_APPLICATION_NAME": values.get("TELNYX_APPLICATION_NAME", "Listency"),
            "TELNYX_PHONE_NUMBER": values.get("TELNYX_PHONE_NUMBER", ""),
            "has_openai_key": bool(values.get("OPENAI_API_KEY")),
            "has_gemini_key": bool(values.get("GEMINI_API_KEY")),
            "has_twilio_auth_token": bool(values.get("TWILIO_AUTH_TOKEN")),
            "has_telnyx_api_key": bool(values.get("TELNYX_API_KEY")),
